...
import com.MarcellaJmartKD.Predicate;
import com.MarcellaJmartKD.Product;
...
public class CouponController implements BasicGetController<Coupon>{
    public static @JsonAutowired(value= Coupon.class, filepath="D:/jmart/src/main/Coupon.json") JsonTable<Coupon> couponTable;
